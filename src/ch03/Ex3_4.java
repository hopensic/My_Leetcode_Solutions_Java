...
public class Ex3_4 {
	public static void main(String[] args) {
		...
		int[] p_array = DataUtil.makeIntArray(20, Order.ASCEND, CanBeRepeat.CAN_REPEAT, 30);
	...
	public static <T extends Comparable<? super T>> void getIntersection(List l1, List l2) {
